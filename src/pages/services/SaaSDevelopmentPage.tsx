...
import { ArrowUpRight, Users, CreditCard, TrendingUp, Globe, Layers, RefreshCw } from "lucide-react";
...
const deliverables = [
  {
    ...
    description: "Efficiently serve multiple customers from a single codebase.",
  },
  {
    icon: CreditCard,
    title: "Subscription Billing",
    description: "Integrated payment systems with flexible pricing tiers.",
  },
  {
    icon: TrendingUp,
    title: "Auto-Scaling",
  ...
  },
  {
    icon: Globe,
    title: "Global CDN",
    description: "Fast content delivery to users worldwide.",
  },
  {
    icon: Layers,
    title: "API-First Design",
    description: "Robust APIs for integrations and extensibility.",
  },
  {
    icon: RefreshCw,
    title: "Continuous Updates",
    description: "Zero-downtime deployments and feature releases.",
  },
];
          ...
          <div className="container mx-auto px-6">
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-muted-foreground mb-8">
                Let's discuss how we can help you launch and scale.
              </p>
              <Link 
                to="/#contact"
